...
"""
	"mount_all_rids.py" will mount all umounted rids
"""
import psutil
import os
import re
...
def Help_RID_Mount_all():
	print("")
	print(sys.argv[0] + " - Mount all umounted Rids")
	print("")
...
if __name__ == '__main__':
	...
	for This_Rid in Rids:
		...
		p = multiprocessing.Process(target = RID_Mount, args=(This_Rid,))
		jobs.append(p)
		p.start()
