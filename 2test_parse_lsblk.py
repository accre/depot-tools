...
for sd_dev, dict in map_sd_to_sg.items():
	...
	print("FOODEBUG testing sd_dev " + str(sd_dev) + " and dict " + str(dict))
...
print("DEBUGDEBUG:  map_lsblk = " + str(map_lsblk))
...
for sd_dev, dict in map_lsblk.items():
	...
	bd = sd_dev
	if multipath_active:
#		bd     = map_lsblk[enclosure][slot]["mpath_dev"]
		bd     = dict["MP_PATH"]
...
#DEBUG: Final sd_dev = /dev/sda
#Traceback (most recent call last):
#  File "/root/git/depot-tools/./2test_parse_lsblk.py", line 801, in <module>
#    bd     = map_lsblk[enclosure][slot]["mpath_dev"]
#NameError: name 'enclosure' is not defined

# '/dev/sdaj': {'KNAME': 'sdaj', 'PATH': '/dev/sdaj', 'MIN': '66:48', 'FSTYPE': 'mpath_member', 'PTUUID': '7705aee8-a903-43bc-93a4-ea090b728a41', 'PTTYPE': 'gpt', 'RA': '128', 'RO': '0', 'RM': '0', 'HOTPLUG': '0', 'MODEL': 'ST16000NM004J', 'SERIAL': 'ZR52H44M0000C1507TMS', 'SIZE': '256', 'STATE': 'running', 'OWNER': 'root', 'GROUP': 'disk', 'MODE': 'brw-rw----', 'ALIGNMENT': '0', 'IO': '0', 'SEC': '512', 'ROTA': '1', 'SCHED': 'mq-deadline', 'TYPE': 'disk', 'ALN': '0', 'GRAN': '0B', 'MAX': '0B', 'ZERO': '0', 'WSAME': '32M', 'WWN': '0x5000c500d77361ab', 'RAND': '1', 'HCTL': '0:0:36:0', 'TRAN': 'sas', 'SUBSYSTEMS': 'block:scsi:pci', 'REV': 'E002', 'VENDOR': 'SEAGATE ', 'ZONED': 'none', 'DAX': '0', 'MP_NAME': 'mpathac', 'MP_KNAME': 'dm-82', 'MP_PKNAME': 'sdbs', 'MP_PATH': '/dev/mapper/mpathac', 'sg_dev': '/dev/sg36', 'hctl': '0:0:36:0', 'lsscsi_wwn': '5000c500d77361ab', 'backplane': '/dev/sg37', 'slot': '23', 'bp_alias': 'Front', 'RID': '5435', 'locate_led': 'Off'}}
